...
let biggerThanLuke = (arr) => {
    ...
    for(let i = 0; i < arr.length; i++){
      console.log(arr[i].mass, lukeMass);
      if(parseInt(arr[i].mass, 10) > parseInt(lukeMass, 10)){
          console.log('hi');
...
const detectTicTacToeWin = (board) => {
  ...
  //check rows:
    board.map((row, x)=>{ 
      if( row[x] ===('X' || 'O') && row[x+1] ===('X' || 'O') &&  row[x+2]===('X' || 'O') ){
        win = 'a rows won'
      }
      return win;
    });
    ...
    board.map((row, x)=>{
      //console.log(board[0][x],  board[1][x],  board[2][x] );
        if( board[0][x] ===('X' || 'O') && board[1][x] ===('X' || 'O') &&  board[2][x]===('X' || 'O') ){
          console.log(board[0][x],  board[1][x],  board[2][x] );
          win=true;
        }
      return win;
    ...
    board.map((row, x)=>{
        if( board[0][x] ===('X' || 'O') && board[1][x+1] ===('X' || 'O') &&  board[2][x+2]===('X' || 'O') ){
          console.log(board[0][x],  board[1][x],  board[2][x] );
          win=true;
        }
      return win;
      ...
      board.map((row, x)=>{
        if( board[0][x+2] ===('X' || 'O') && board[1][x+1] ===('X' || 'O') &&  board[2][x]===('X' || 'O') ){
          console.log(board[0][x],  board[1][x],  board[2][x] );
          win=true;
        }
      return win;
