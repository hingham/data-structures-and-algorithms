...
const mapTwoToThe = (arr) => {
  ...
  //I used MDN array.map page to model a few examples include on their site: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map
...
const charCode = (arr) => {
  let newArr = arr.map(function(letter, index){
    return letter.charCodeAt(0);
  })
  return newArr;
};

//Used the MDN documentation on chatCodeAt(): https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/charCodeAt
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
const evenOdd = (arr) => {
    let newArr = arr.map(function (num,idx){
      if(Math.abs(num%2) === 0){
        return num = 'even';
      }
...
const extractAbilities = (arr) => {
    let newArr = arr.map(function (name, idx){
...
const extractStats = (arr) => {
    let newArr = arr.map(function (value, idx){
      var result = {
