...
const sortMeetingsByDay = (arr) => {
    arr.forEach(element =>{
      if (element.dayOfWeek === 'Monday'){
        element.dayOfWeek = 1;
      }
      else if (element.dayOfWeek ==='Friday'){
        element.dayOfWeek=5;
      }
      else if (element.dayOfWeek ==='Tuesday'){
        element.dayOfWeek =2;
      }
      else if (element.dayOfWeek ==='Wednesday'){
        element.dayOfWeek = 3;
      }
      else if (element.dayOfWeek ==='Thursday'){
        element.dayOfWeek =4;
      }
    });
